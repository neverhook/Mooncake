...
class Client {
   public:
    ...
    void ObserveNvlinkHostNumaCapacity(uint64_t requested_bytes,
        ...
        if (metrics_ != nullptr) {
            metrics_->ObserveNvlinkHostNumaCapacity(requested_bytes,
                                                    effective_bytes);
        }
    }
    ...
    void ObserveNvlinkHostNumaNode(int numa_node, uint64_t effective_bytes,
        ...
        if (metrics_ != nullptr) {
            metrics_->ObserveNvlinkHostNumaNode(numa_node, effective_bytes,
                                                chunk_count);
        }
    }
    ...
    void ObserveNvlinkHostNumaStage(NvlinkHostNumaStage stage,
        ...
        if (metrics_ != nullptr) {
            metrics_->ObserveNvlinkHostNumaStage(stage, duration_us, success);
        }
    }

    void ObserveNvlinkHostNumaRollback(bool success) {
        if (metrics_ != nullptr) {
            metrics_->ObserveNvlinkHostNumaRollback(success);
        }
    }
